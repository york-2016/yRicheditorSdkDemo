...
public class RichEditor extends WebView {
    ...
    private void callback(String text) {
        String[] str = text.split("york&&&&");
        mContents = str[0].replaceFirst(CALLBACK_SCHEME, "");
        mContents = mContents.replaceAll("york&&&&", "");
        if (str.length > 1) {
            stateCheck(str[1].replaceAll("york&&&&", ""));
        }
    ...
    public void setEditorFontBackgroundColor(int color) {
